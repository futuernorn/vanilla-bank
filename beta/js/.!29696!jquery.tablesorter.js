...
// cssHeader:"header",cssAsc:"",cssDesc:"",cssChildRow:"expand-child"
				// *** css class names
				...
				cssIcon          : 'icon', //  if this class exists, a <i> will be added to the header automatically
				cssInfoBlock     : 'infoOnly', // don't sort tbody with this class name
				cssProcessing    : 'processing', // processing icon applied to header during sort/filter
